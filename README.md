...
- [Stealth Chrome DevTools MCP](https://github.com/DevinoSolutions/stealth-chrome-devtools-mcp) - Undetectable browser automation using nodriver (CDP-based) with anti-bot evasion, persistent login sessions via master/snapshot/clone profiles, and cookie management tools.
